...
class PackProducts(models.Model):
    ...
    lot_or_serial_number = fields.Char(string='Lot/Serial Number',
                                help='The lot/serial number of the product.')
    cost = fields.Float(
        string='Cost', 
        help='The cost of the product.',
    )
    ...
    note = fields.Text(string='Note', help='The note of the product.')
